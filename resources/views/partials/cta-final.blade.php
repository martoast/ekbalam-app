{{-- ============================== CTA FINAL ============================== --}}
<section class="grain relative flex min-h-[80svh] items-center overflow-hidden bg-balam-950">
    <div class="absolute inset-0">
        <img src="{{ asset('images/ek-fachada-noche.jpg') }}" alt="Fachada nocturna de Ek Balam 36 — render ilustrativo" loading="lazy"
            class="h-full w-full object-cover object-center">
        <div class="absolute inset-0 bg-gradient-to-t from-balam-950/90 via-balam-950/45 to-balam-950/55"></div>
    </div>
    <div class="relative mx-auto max-w-3xl px-6 text-center lg:px-10">
        <div class="reveal-group">
            <h2 class="display text-4xl font-light text-sand-50 drop-shadow-[0_2px_24px_rgba(7,29,33,0.6)] sm:text-5xl lg:text-6xl">
                Conoce <span class="accent-italic">Ek Balam 36</span>
            </h2>
            <p class="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-sand-100/90 drop-shadow-[0_2px_18px_rgba(7,29,33,0.6)]">
                Solicita información sobre tipologías, disponibilidad, precios y condiciones vigentes de este proyecto residencial y comercial en Puerto Morelos.
            </p>
